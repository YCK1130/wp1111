...
- 楊竣凱：
  處理 admin 新增、更改借用物頁面、及相關更新 broadcast 內容與美化、完成 status 跳出之功能，其負責頁面的 RWD
- 陳冠豪：
  處理 user 借用流程頁面(userProgress)，發送 request 之 broadcast 功能，並一併完善 websocket 連接及 mongoDB schema 存儲，其負責頁面的 RWD
- 葉庭羽：
  處理 user status list 的頁面，並完成計時、呼叫、及相關 broadcast 內容與美化等功能，其負責頁面的 RWD

## 附錄

- 專案資料夾結構圖(有\*之檔案為從資訊部修改，其餘皆為原創功能)
...
│  │
│  └─photoData
│          MakeNTU2022_icon.png
│          MakeNTU2022_icon_128x128.png
│          MakeNTU2022_icon_16x16.png
│          MakeNTU2022_icon_32x32.png
│          MakeNTU2022_icon_64x64.png
│          nano33.jpg
│
├─server
│  │  api.js
...
└─src
    ...
    │  │  └─components
    │  │          GroupContent.js
    │  │          GroupContentElement.js
    │  │          GroupStatus.js
    │  │          RequestStatus.js
    │  │          RequestStatusContent.js
    │  │
    │  ├─teamData
    │  │      index.js
    │  │      teams-example.csv
